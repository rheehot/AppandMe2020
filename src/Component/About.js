    ...
    return (
        <div className="about">
            ...
            <div className="about-intro">
                ...
                <div>앱앤미는 미림여자정보과학고등학교의 대표적인 전공동아리 중 하나로 다양한 차세대 IT개발 흐름에 따른 기술들을 익히고 연구하며 실제 서비스 구현을 통해 학교 및 사회에 기여하는 동아리 입니다. 개발자와 디자이너, 기획자의 협업을 통해 전공실력을 보다 더 키워나갈 수 있을뿐만 아니라 각종 IT 관련 공모전 및 대외 활동을 통해 전공 실력과 발표 경험을 쌓을 수 있습니다. 또한 동아리 담당 전공 선생님과 함께하는 동아리 시간을 활용하여 각의 전공 실력을 기를 수 있습니다.</div>
                <hr />
            </div>
